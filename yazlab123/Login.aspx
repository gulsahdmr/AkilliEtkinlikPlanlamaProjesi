...
<body>
    <div class="center-container">
        ...
        <form id="loginForm" runat="server">
            ...
            <!-- Sadece bir Şifremi Unuttum butonu -->
            <asp:Button ID="BtnSifremiUnuttum" runat="server" CssClass="button button-login" Text="Şifremi Unuttum" OnClick="btnSifremiUnuttum_Click" />
